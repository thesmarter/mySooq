...
class FilterNavItems extends StatefulWidget {
  const FilterNavItems({this.changeAppBarTitle, required this.onSubCategorySelected});
    ...
    return Container(
      ...
      child:  Row(
        ...
        children: <Widget>[
          ...
          Row(
            children: <Widget>[
              CustomCategoryIconWidget(onSubCategorySelected: widget.onSubCategorySelected,),
