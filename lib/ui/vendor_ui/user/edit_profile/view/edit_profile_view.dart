...
import 'package:sooq/core/vendor/provider/user/user_feild_provider.dart';
import 'package:sooq/core/vendor/repository/user_field_repository.dart';
import 'package:sooq/core/vendor/viewobject/custom_field.dart';
import 'package:sooq/core/vendor/viewobject/edit_profile_user_relation.dart';
import 'package:sooq/core/vendor/viewobject/holder/request_path_holder.dart';
import 'package:sooq/core/vendor/viewobject/selected_object.dart';
import 'package:sooq/core/vendor/viewobject/selected_value.dart';
import 'package:sooq/ui/vendor_ui/common/dialog/warning_dialog_view.dart';
import 'package:sooq/ui/vendor_ui/common/ps_app_bar_widget.dart';
import 'package:sooq/ui/vendor_ui/common/user_custom_ui/ps_user_cutom_widget.dart';
...
class _EditProfileViewState extends State<EditProfileView>
  ...
  final TextEditingController customFiledWhatsappTextController = TextEditingController();
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        body: MultiProvider(
            ...
            child: Consumer2<UserProvider,UserFieldProvider>(builder: (BuildContext context,
                UserProvider userProvider,UserFieldProvider fieldProvider, Widget? child) {
  ...
  dynamic onTapSave(BuildContext context, UserProvider provider) async {
    ...
    if (result == true) {
      if (userNameController.text == '') {
        ...
        !hasCountryCode(customFiledWhatsappTextController.text) && customFiledWhatsappTextController.text != '') {
        showDialog<dynamic>(
            context: context,
            builder: (BuildContext context) {
              return ErrorDialog(
