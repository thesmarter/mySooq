...
import 'package:sooq/core/vendor/provider/blog/blog_provider.dart';
import 'package:sooq/core/vendor/provider/category/category_provider.dart';
import 'package:sooq/core/vendor/provider/chat/user_unread_message_provider.dart';
import 'package:sooq/core/vendor/provider/gallery/gallery_provider.dart';
...
import 'package:sooq/core/vendor/provider/package_bought/package_bought_transaction_provider.dart';
import 'package:sooq/core/vendor/provider/product/added_item_provider.dart';
import 'package:sooq/core/vendor/provider/product/disabled_product_provider.dart';
import 'package:sooq/core/vendor/provider/product/discount_product_provider.dart';
import 'package:sooq/core/vendor/provider/product/favourite_item_provider.dart';
import 'package:sooq/core/vendor/provider/product/item_entry_provider.dart';
import 'package:sooq/core/vendor/provider/product/item_list_from_followers_provider.dart';
import 'package:sooq/core/vendor/provider/product/mark_sold_out_item_provider.dart';
import 'package:sooq/core/vendor/provider/product/nearest_product_provider.dart';
import 'package:sooq/core/vendor/provider/product/paid_ad_product_provider%20copy.dart';
import 'package:sooq/core/vendor/provider/product/paid_id_item_provider.dart';
import 'package:sooq/core/vendor/provider/product/pending_product_provider.dart';
import 'package:sooq/core/vendor/provider/product/popular_product_provider.dart';
import 'package:sooq/core/vendor/provider/product/product_provider.dart';
import 'package:sooq/core/vendor/provider/product/recent_product_provider.dart';
import 'package:sooq/core/vendor/provider/product/rejected_product_provider.dart';
import 'package:sooq/core/vendor/provider/product/related_product_provider.dart';
import 'package:sooq/core/vendor/provider/product/search_product_provider.dart';
import 'package:sooq/core/vendor/provider/product/sold_out_item_provider.dart';
import 'package:sooq/core/vendor/provider/product/touch_count_provider.dart';
import 'package:sooq/core/vendor/provider/user/top_seller_provider.dart';
...
import 'package:sooq/core/vendor/viewobject/holder/product_parameter_holder.dart';
  ...
  final Map<String, Map<String, SingleChildWidget>> providerMap =
    ...
    'category': <String, SingleChildWidget>{
      PsProviderConst.init_category_provider:
          initCategoryProvider(context, (CategoryProvider pro) {
