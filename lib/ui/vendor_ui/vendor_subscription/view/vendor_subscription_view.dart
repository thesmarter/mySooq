...
import 'package:sooq/core/vendor/provider/vendor_subscription_plan/vendor_subscription_plan_provider.dart';
...
import 'package:sooq/ui/custom_ui/vendor_subscription/component/vendor_subscription_card.dart';
...
import '../../../../core/vendor/repository/vendor_subscription_plan_repository.dart';
...
class _VendorSubscriptionViewState extends State<VendorSubscriptionView> {
  ...
  VendorSubscriptionPlanRepository? repo1;
  ...
  Widget build(BuildContext context) {
    repo1 = Provider.of<VendorSubscriptionPlanRepository>(context);
      ...
      body: ChangeNotifierProvider<VendorSubscriptionPlanProvider?>(
        ...
        create: (BuildContext context) {
          subscriptionPlanProvider =
              VendorSubscriptionPlanProvider(repo: repo1);
