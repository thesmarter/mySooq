...
class _ApplyButtonWidgetState extends State<ApplyButtonWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return PSButtonWidget(
        ...
        onPressed: () async {
            // if(widget.psValueHolder.vendorSubscriptionSetting != PsConst.VENDOR_SUBSCRIPTION_FREE ){
            //   Navigator.pushNamed(context, 
            //     RoutePaths.vendorSubScription,
              ...
              if (_apiStatus.data != null &&
                  _apiStatus.status == PsStatus.SUCCESS) {
                   PsProgressDialog.dismissDialog();
                    print(psValueHolder.vendorSubscriptionSetting != PsConst.VENDOR_SUBSCRIPTION_FREE && widget.flag == PsConst.ADD_NEW_ITEM);
                  if(psValueHolder.vendorSubscriptionSetting != PsConst.VENDOR_SUBSCRIPTION_FREE && widget.flag == PsConst.ADD_NEW_ITEM){
                    Navigator.pushNamed(
                    context, RoutePaths.vendorSubScription,
                    arguments: <String, dynamic>{
                      'android': psValueHolder.packageAndroidKeyList,
                      'ios': psValueHolder.packageIOSKeyList,
                   ...
                   PsProgressDialog.dismissDialog();
                   Navigator.pushNamed(context, 
                   RoutePaths.vendorRegisterationSuccess
                   );
                // showDialog<dynamic>(
                //     context: context,
