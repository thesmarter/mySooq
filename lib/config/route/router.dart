...
import 'package:sooq/core/vendor/viewobject/holder/intent_holder/vendor_application_form_intent_holder.dart';
import 'package:sooq/core/vendor/viewobject/holder/intent_holder/vendor_user_intent_holder.dart';
import 'package:sooq/core/vendor/viewobject/holder/product_detail_and_address_intent_holder.dart';
import 'package:sooq/ui/custom_ui/item/entry/category/view/entry_category_vertical_list_view_container.dart';
import 'package:sooq/ui/custom_ui/item/price_range/view/choose_price_range_view.dart';
import 'package:sooq/ui/custom_ui/map/view/map_pin_view.dart';
import 'package:sooq/ui/custom_ui/user/profile/component/my_vendor/my_vendor_vertical_list_view.dart';
import 'package:sooq/ui/custom_ui/user/user_vendor_detail/view/user_vendor_detail_view.dart';
import 'package:sooq/ui/custom_ui/vendor/view/latest_vendor_filter_view.dart';
import 'package:sooq/ui/custom_ui/vendor/view/latest_vendor_vertical_list_view.dart';
import 'package:sooq/ui/custom_ui/vendor/view/search_vendor_view.dart';
import 'package:sooq/ui/custom_ui/vendor_applicaion/view/vendor_application_form_container_view.dart';
import 'package:sooq/ui/custom_ui/vendor_subscription/view/vendor_registeration_success_view.dart';
import 'package:sooq/ui/custom_ui/vendor_subscription/view/vendor_subscription_view.dart';
import 'package:sooq/ui/vendor_ui/checkout/component/billing_address/billing_address.dart';
import 'package:sooq/ui/vendor_ui/checkout/component/shipping_address/shipping_address.dart';
import 'package:sooq/ui/vendor_ui/checkout/component/billing_address/billing_country_code.dart';
import 'package:sooq/ui/vendor_ui/checkout/view/checkout_view.dart';
import 'package:sooq/ui/vendor_ui/checkout/component/shipping_address/shipping_country_code.dart';
import 'package:sooq/ui/vendor_ui/order_detail/view/order_detail_view.dart';
import 'package:sooq/ui/vendor_ui/order_successful/view/order_successful_view.dart';
  ...
  switch (settings.name) {
    ...
    case '${RoutePaths.productDetail}':
      ...
      final ProductDetailAndAddress holder =
          (args as ProductDetailAndAddress? ?? ProductDetailAndAddress)
              as ProductDetailAndAddress;
          ...
          builder: (BuildContext context) {
            return CustomProductDetailView(
              productDetailAndAddress: ProductDetailAndAddress(
                  productDetailIntentHolder: holder.productDetailIntentHolder,
                  shippingAddressHolder: holder.shippingAddressHolder,
                  billingAddressHolder: holder.billingAddressHolder),
              // productId: holder.productDetailIntentHolder?.productId,
              // heroTagImage: holder.productDetailIntentHolder?.heroTagImage,
              // heroTagTitle: holder.productDetailIntentHolder?.heroTagTitle,
            );
          });
    ...
    case '${RoutePaths.checkout}':
      ...
      return MaterialPageRoute<dynamic>(
          ...
          builder: (BuildContext context) {
            return CheckoutView(
              productDetailAndAddress: holder,
              // productId: holder.productDetailIntentHolder?.productId,
              // userQty: holder.productDetailIntentHolder?.userQty,
              // stockQty: holder.productDetailIntentHolder?.stockQty,
              // shippingAddressHolder: holder.shippingAddressHolder,
              // billingAddressHolder: holder.billingAddressHolder,
            );
    ...
    case '${RoutePaths.shippingAddress}':
      ...
      final ProductDetailAndAddress holder =
          (args as ProductDetailAndAddress? ?? ProductDetailAndAddress)
              as ProductDetailAndAddress;
      return MaterialPageRoute<dynamic>(
          settings: const RouteSettings(name: RoutePaths.shippingAddress),
          builder: (BuildContext context) {
    ...
    case '${RoutePaths.orderSuccessful}':
      ...
      final ProductDetailIntentHolder holder =
          (args as ProductDetailIntentHolder? ?? ProductDetailIntentHolder)
              as ProductDetailIntentHolder;
      return MaterialPageRoute<dynamic>(
          settings: const RouteSettings(name: RoutePaths.orderSuccessful),
          builder: (BuildContext context) {
            return OrderSuccessfulView(
              productDetailIntentHolder: holder,
            );
          });
